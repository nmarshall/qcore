...
void base_wrap()  {
	...
	/*
    //class_<ivalue, bases<basedes, observable> >("ivalue","General Value Object",no_init)
    ...
    class_<iparameter, bases<icodename, lazy> >("iparameter","Parameter interface", init<>())
		...
		.add_property("lowerbound",			&iparameter::lower_bound)
		.add_property("upperbound",			&iparameter::upper_bound)
